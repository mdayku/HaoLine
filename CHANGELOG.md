...
- CLI now supports GGUF files with full LLM details in exports (MD/HTML/JSON)
- CLI output shows model name, architecture, and parameter count for GGUF files
- Parity with Streamlit for GGUF analysis
